                  ...
                  <>
                    ...
                    >
                      ...
                      <div className="space-y-0.5 text-xs font-medium">
                        ...
                        <div className="p-2 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/60 dark:border-slate-700/60 space-y-1.5 my-1">
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Regional Market</p>
                          <div className="grid grid-cols-2 gap-1.5">
                            <button
                              type="button"
                              onClick={() => setCountry('GH')}
                              className={`px-2 py-1 rounded-lg text-[11px] font-bold transition-all flex items-center justify-center gap-1 ${
                                country === 'GH'
